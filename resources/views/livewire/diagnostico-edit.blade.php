            ...
            <div class="mt-6 border bg-white rounded-lg p-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <button wire:click="createImage" wire:loading.attr="disabled" wire:target="createImage, url" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded text-sm px-5 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Agregar</button>
                        </div>
                    </div>
